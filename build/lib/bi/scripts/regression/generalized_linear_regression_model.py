...
class GeneralizedLinearRegressionModelScript(object):
    ...
    def Train(self):
        ...
        algoSetting = [x for x in algosToRun if x["algorithmSlug"]==GLOBALSETTINGS.MODEL_SLUG_MAPPING["generalizedlinearregression"]][0]
