        ...
        if self._mlEnv == "spark":
            ...
            if algoSetting.is_hyperparameter_tuning_enabled():
                ...
                if hyperParamAlgoName == "gridsearchcv":
                    ...
                    sklearnHyperParameterResultObj = SklearnGridSearchResult(clfGrid.cv_results_, clf, x_train, x_test,
                                                                             y_train, y_test, appType, modelFilepath,
                                                                             levels, posLabel, evaluationMetricDict)
                    ...
                    self._result_setter.set_metadata_parallel_coordinates(self._slug, {
                        "ignoreList": sklearnHyperParameterResultObj.get_ignore_list(),
                        "hideColumns": sklearnHyperParameterResultObj.get_hide_columns(),
                        "metricColName": sklearnHyperParameterResultObj.get_comparison_metric_colname(),
                ...
                if validationDict["name"] == "kFold":
                    ...
                    if numFold == 0:
                        numFold = 3
                    kFoldClass = SkleanrKFoldResult(numFold, clf, x_train, x_test, y_train, y_test, appType, levels,
                                                    posLabel, evaluationMetricDict=evaluationMetricDict)
            ...
            lrCards = [json.loads(CommonUtils.convert_python_object_to_json(cardObj)) for cardObj in
            ...
            self._result_setter.set_logistic_regression_management_summary(modelManagementJson)
