...
class NNPTClassificationScript(object):
    def __init__(self, data_frame, df_helper, df_context, spark, prediction_narrative, result_setter, meta_parser, mlEnvironment="sklearn"):
        ...
        self._slug = self._model_slug_map["PyTorch"]
        ...
        self._scriptStages = {
            "initialization":{
                "summary":"Initialized The PyTorch Scripts",
                "weight":1
                },
            "training":{
                "summary":"PyTorch Training Started",
                "weight":2
                },
            "completion":{
                "summary":"PyTorch Training Finished",
                "weight":1
                },
            }
    ...
    def Train(self):
        ...
        if  self._mlEnv == "spark":
            ...
            self._model_summary.set_algorithm_name("PyTorch")
            self._model_summary.set_algorithm_display_name("PyTorch")
            ...
            if algoSetting.is_hyperparameter_tuning_enabled():
                ...
                self._model_management.set_algorithm_name("PyTorch")#algorithm name
            ...
            self._result_setter.set_model_summary({"PyTorch":json.loads(CommonUtils.convert_python_object_to_json(self._model_summary))})
            ...
            self._result_setter.set_nnptc_fail_card({"Algorithm_Name":"PyTorch","success":"True"})
    ...
    def Predict(self):
        ...
        self._scriptStages = {
            ...
            "prediction":{
                "summary":"PyTorch Scripts Model Prediction Finished",
                "weight":2
                },
            "frequency":{
