...
class DecisionTreeScript:
    ...
    def Run(self):
        ...
        #Narratives
        narratives_obj = DecisionTreeNarrative(self._dataframe_context.get_result_column(), df_decision_tree_obj, self._dataframe_helper, self._dataframe_context, self._story_narrative,self._result_setter)
