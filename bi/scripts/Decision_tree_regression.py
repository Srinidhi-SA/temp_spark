...
from bi.stats.regression import DecisionTrees
...
class DecisionTreeRegressionScript:
    ...
    def Run(self):
        ...
        df_decision_tree_obj = DecisionTrees(self._data_frame, self._dataframe_helper, self._spark).test_all(measure_columns=(self._dataframe_context.get_result_column(),))
