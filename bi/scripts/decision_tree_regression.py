...
class DecisionTreeRegressionScript:
    ...
    def Run(self):
        ...
        #Narratives
        narratives_obj = DecisionTreeRegNarrative(self._dataframe_context.get_result_column(), df_decision_tree_obj, self._dataframe_helper, self._dataframe_context, self._result_setter,self._story_narrative)
