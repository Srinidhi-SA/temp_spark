...
class MetaDataHelper():
    ...
    def calculate_dimension_column_stats_per_column(self, df, column, summary_df, total_count, level_count_flag, displayNameDict, displayOrderDict):
        df1 = df.select(column)
        st = time.time()
        col_stat = {}
        chart_data = {}
    ...
    def calculate_time_dimension_column_stats_per_column(self, df, column, summary_df, total_count, level_count_flag, displayNameDict, displayOrderDict):
        df1 = df.select(column)
        col_stat = {}
    ...
    def calculate_time_dimension_column_stats_from_string_per_column(self, df, column, total_count, level_count_flag, displayNameDict, displayOrderDict, unprocessed_columns):
        df1 = df.select(column)
        col_stat = {}
        chart_data = {}
        output = {}
    ...
    def calculate_time_dimension_column_stats_from_string(self, df, td_columns,**kwargs):
        ...
        for column in td_columns:
            ...
            i+=1
            output, chart_data, unprocessed_columns = self.calculate_time_dimension_column_stats_from_string_per_column(df, column, total_count, level_count_flag, displayNameDict, displayOrderDict, unprocessed_columns)
        return output,chart_data,unprocessed_columns
