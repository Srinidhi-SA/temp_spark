def get_story_config():
    storyConfig = {
      ...
      "job_config": {
        "message_url": "http://34.196.204.54:9012/api/messages/Job_master-dim1-6a9a0u97s5-tlkdiasytj_123/",
        "get_config": {
          "action": "get_config",
          "method": "GET"
        },
        "error_reporting_url": "http://34.196.204.54:9012/api/set_job_report/master-dim1-6a9a0u97s5-tlkdiasytj/",
        "set_result": {
          "action": "result",
          "method": "PUT"
        },
        "job_url": "http://34.196.204.54:9012/api/job/master-dim1-6a9a0u97s5-tlkdiasytj/",
        "job_type": "story",
        "job_name": "dim1",
        "xml_url": "http://34.196.204.54:9012/api/xml/master-dim1-6a9a0u97s5-tlkdiasytj/",
        "app_id": None
      }
    }
    return storyConfig
